...
class ASAP {
  ...
  protected static async init({
    ...
    await asap.batch.ensureContract();
    await asap.certificateAuthority.ensureContract();
    await asap.company.ensureContract();
    await asap.material.ensureContract();
    await asap.transport.ensureContract();
    return asap;
  }
  /**
