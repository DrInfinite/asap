...
import ASAPLogoFullLight from '@assets/svg/asap-logo-full-light.svg';
  ...
  return (
    <InformationContainer>
      ...
      <InformationHeader>
        ...
        <InformationHeaderDescription>
          ASAP leverages blockchain technology to facilitate efficient
      ...
      <Container>
        ...
        <InformationSection>
          ...
          <Col>
            <Row centered>
              <InformationContent>
                <strong>ASAP</strong> infrastructure creates a unique
              ...
              <InformationContent>
                ASAP uses the NFT(Non-fungible tokens) paradigm, which
        ...
        <InformationSection>
          ...
          <Col>
            <Row centered>
              <InformationContent>
                ASAP provides a web3 based library that interacts with the
