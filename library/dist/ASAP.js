...
class ASAP {
    /**
     * ASAP constructor function
     *
     * @param options       An object containing ASAP configuration parameters
    ...
    static init({ httpProvider, privateKey, factoryContractAddress, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield asap.batch.ensureContract();
            yield asap.certificateAuthority.ensureContract();
            yield asap.company.ensureContract();
            yield asap.material.ensureContract();
            yield asap.transport.ensureContract();
            return asap;
        });
    }
    /**
     * Creates a new ASAP instance. Similar to web3Init.
     * @see {@link web3Init}
     *
     * @param options       An object containing ASAP configuration parameters
